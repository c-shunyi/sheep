...
<template>
	<view class="bg-register">
		...
		<u-popup :show="eweShow" @close="eweShow = false" bgColor="transparent" mode="center" :safeAreaInsetBottom="false">
					...
					<view class="u-p-12 flex flex-center" style="width: 360rpx;height: 100rpx;background: #EDFFD7;border-radius: 50rpx;">
						<u-number-box v-model="eweNum" :min="0">
							...
							<view class="u-mx-32" slot="input" style="width: 120rpx;">
								<u--input  border="none" v-model="eweNum" inputAlign="center" fontSize="40rpx"></u--input>
							</view>
